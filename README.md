...
Knowing the kerf of the cut (which changes with every laser cutter, with every material, and with every color of every material) allows you to make more accurate cuts.
